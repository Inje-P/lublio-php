        ...
        <div style="margin-bottom: 20px;">
            <a href="/lublio/learn/english/">
                <div class="styled-box-pink animated riseUp_1">
                    <h2>ENGLISH</h2>
                    <h3 style="font-family: 'Pretendard-Regular', sans-serif; font-weight: 600">
                        영어
                    </h3>
                    <p>
